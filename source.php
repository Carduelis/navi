    ...
    <div class="promo-text">
        ...
        <div>
            <ul>
                ...
                <li>API-документация фреймворка jQuery.//[Электронный ресурс].-Режим доступа: <a href="http://api.jquery.com">http://api.jquery.com</a>  (По состоянию на 12.11.13)
                <li>Сайт плагина-слайдера bxslider .//[Электронный ресурс].-Режим доступа: <a href="http://bxslider.com/">http://bxslider.com/</a> (По состоянию на 12.11.13)
                <li>Википедия. Свободная Энциклопедия.//[Электронный ресурс].-Режим доступа: <a href="http://ru.wikipedia.org/wiki/">http://ru.wikipedia.org/wiki/</a>  (По состоянию на 12.11.13)
                <li>Методические указания по выполнению курсовой работы по дисциплине «Мировые информационные ресурсы»
